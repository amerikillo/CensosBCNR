...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <h3 class="text-primary"><a name="top" id="top"></a>Consulta de Censos de Unidades de Primer Nivel - BAJA CALIFORNIA</h3>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <a href="http://166.78.128.202:8080/CensosBCNR/indexSelec.html" class="btn btn-primary">Men&uacute;</a>
                    <a href="http://166.78.128.202:8080/CensosBCNR/estadisticasA.jsp" class="btn btn-info">Estadísticas</a>
        ...
        <table width="900px" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td colspan="12">
                    ...
                    <h2>Seleccione la Unidad de Primer Nivel de Consulta</h2>
                </td>
                </td>
            </tr>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr height="20">
                                        ...
                                        <td><%=format.format(Integer.parseInt(rset_inv.getString("cant")))%></td>
                                    </tr>
                                    <%
                                            }
                                            con.cierraConexion();
...
<script src="js/dataTables.numericComma.js"></script>
<script>
